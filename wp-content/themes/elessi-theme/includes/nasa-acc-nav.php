        ...
        <ul>
            <?php foreach ($menu_items as $endpoint => $label) : ?>
                <li class="<?php echo wc_get_account_menu_item_classes($endpoint); ?>">
                    <a href="<?php echo esc_url(wc_get_account_endpoint_url($endpoint)); ?>" title="<?php echo esc_attr($label); ?>" class="nasa-flex"<?php echo wc_is_current_account_menu_item( $endpoint ) ? ' aria-current="page"' : ''; ?>>
                        <?php
                        /**
                         * SVG
                         */
