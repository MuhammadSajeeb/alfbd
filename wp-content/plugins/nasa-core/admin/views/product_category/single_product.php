...
if (is_object($term) && $term) {
    ...
    <tr class="form-field nasa-term-root-child <?php echo $this->_product_layout . ' nasa-term-' . $this->_product_layout . '-modern-2 nasa-term-' . $this->_product_layout . '-modern-3 nasa-term-' . $this->_product_layout . '-modern-4'; ?> hidden-tag ns-advance-field">
        <th scope="row" valign="top">
...
<?php } else { ?>
    ...
    <div class="form-field nasa-term-root-child <?php echo $this->_product_layout . ' nasa-term-' . $this->_product_layout . '-modern-2 nasa-term-' . $this->_product_layout . '-modern-3 nasa-term-' . $this->_product_layout . '-modern-4'; ?> hidden-tag ns-advance-field">
        <label for="<?php echo $this->_product_layout_bg_color; ?>"><?php _e('Background Single Product Layout', 'nasa-core'); ?></label>
        <div class="nasa_p_color">
