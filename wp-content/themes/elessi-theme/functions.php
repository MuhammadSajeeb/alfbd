...
defined('NASA_VERSION') or define('NASA_VERSION', '6.1.8');
...
if (!function_exists('elessi_setup')) :
    function elessi_setup() {
        ...
        $mofile5 = ELESSI_THEME_PATH . '/languages/' . $df_mofile;
        ...
        } elseif (file_exists($mofile5)) {
            load_textdomain('elessi-theme', $mofile5);
        } else {
            /**
             * Default template
             */
        ...
        require ELESSI_THEME_PATH . '/widgets/wg-nasa-product-filter-alphabet.php';
